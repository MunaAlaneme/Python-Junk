...
playlist = list()
playlist.append ( "./Games/Space Vaders/audio/Kevin MacLeod - Space Fighter Loop.wav" )
playlist.append ( "./Games/Space Vaders/audio/Kevin MacLeod - Space Fighter Loop.wav" )
...
icon = pygame.image.load('./Games/Space Vaders/img/SPACE FIGHTERS SVG icons8.png')
pygame.display.set_icon(icon)
background = pygame.image.load('./Games/Space Vaders/img/5438849.jpg')
background = pygame.transform.scale(background, (screen_width, screen_height))
backgroundRect = pygame.Rect(background.get_rect())
backgroundRect.clamp_ip(pygame.display.get_surface().get_rect())

# Player
playerImg = pygame.image.load('./Games/Space Vaders/img/player.png')
...
enemyImg = pygame.image.load(f"./Games/Space Vaders/img/alien{enemyImageNumber}.png")
